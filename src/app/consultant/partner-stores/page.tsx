...
export default function PartnerStoresPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-1000">
          ...
          <DialogContent className="bg-background border-primary/10 text-foreground rounded-[2.5rem] p-10 max-w-xl">
            ...
            <div className="space-y-6 py-6 font-sans">
              <div className="space-y-2">
                ...
                <Input className="bg-primary/[0.02] border-primary/10 h-14 rounded-2xl focus:ring-primary/20" placeholder="Ex: Zara" />
              </div>
              <div className="space-y-2">
                <Label className="text-muted-foreground font-bold text-xs uppercase tracking-widest px-1">Link de Afiliado</Label>
                <Input className="bg-primary/[0.02] border-primary/10 h-14 rounded-2xl focus:ring-primary/20" placeholder="https://..." />
              </div>
              <div className="space-y-2">
              ...
              <Button className="w-full bg-primary hover:bg-primary/90 text-primary-foreground font-bold h-14 rounded-2xl shadow-lg border-none text-base mt-4">Salvar Parceiro</Button>
            </div>
          </DialogContent>
        </Dialog>
      </div>
      ...
      <Tabs defaultValue="lojas" className="w-full" onValueChange={setActiveTab}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[1, 2, 3].map((i) => (
              <motion.div 
                ...
                key={i}
              >
                <Card className="border-none bg-card/60 backdrop-blur-md shadow-sm hover:shadow-md transition-all rounded-[2.5rem] group overflow-hidden">
                  <div className="h-40 bg-primary/5 flex items-center justify-center relative overflow-hidden group-hover:bg-primary/10 transition-colors duration-500">
                  ...
                  <div className="relative -mt-12 mx-8 bg-background rounded-[2rem] border border-primary/5 p-6 shadow-xl shadow-black/[0.02]">
                    <div className="flex justify-between items-center">
                      <h3 className="text-foreground text-xl font-bold tracking-tight">Loja Exemplo {i}</h3>
                      <Badge className="bg-primary/5 text-primary border-none rounded-lg px-2 py-1 text-[10px] font-bold">Vestuário</Badge>
                    </div>
                  </div>
                  <CardContent className="p-8 pt-6 space-y-6">
                    <p className="text-muted-foreground text-sm italic font-medium leading-relaxed">"Curadoria exclusiva de peças atemporais para clientes de consultoria premium."</p>
                    <div className="flex gap-3">
                      <Button variant="outline" className="flex-1 h-12 border-primary/20 text-primary hover:bg-primary/5 rounded-2xl font-bold text-xs gap-2">
