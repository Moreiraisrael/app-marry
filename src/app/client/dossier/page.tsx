...
import { 
  Sparkles, Palette, User, BookOpen, 
    ...
    <div className="max-w-5xl mx-auto space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-1000">
        ...
        <Card className="border-rose-100 bg-white shadow-xl shadow-rose-50/50 rounded-3xl overflow-hidden group hover:shadow-rose-100/50 transition-all duration-500">
          ...
          <CardContent className="p-8 space-y-6">
            <div className="bg-rose-50/50 p-6 rounded-2xl border border-rose-100/50 text-center">
              ...
              <h3 className="text-2xl font-serif text-neutral-900 mt-1">Inverno Frio</h3>
            </div>
            <div className="grid grid-cols-5 gap-3">
              {['#1A1A1A', '#2E5A88', '#8B0000', '#FFFFFF', '#C0C0C0'].map((color, i) => (
                <div key={i} className="group/color relative">
                  <div 
                    className="w-12 h-12 rounded-full shadow-inner border border-white/20 transition-transform group-hover/color:scale-110" 
        ...
        <Card className="border-rose-100 bg-white shadow-xl shadow-rose-50/50 rounded-3xl overflow-hidden group hover:shadow-rose-100/50 transition-all duration-500">
          ...
          <CardContent className="p-8 space-y-6">
            <div className="bg-rose-50/50 p-6 rounded-2xl border border-rose-100/50 text-center">
              ...
              <h3 className="text-2xl font-serif text-neutral-900 mt-1">A Governante</h3>
            </div>
            <p className="text-neutral-600 text-sm leading-relaxed">
              Sua imagem comunica <strong>autoridade, elegância e controle</strong>. Você prefere linhas estruturadas e elementos de alta qualidade que reforçam sua credibilidade.
            </p>
          </CardContent>
        </Card>
      </div>
      ...
      <Card className="border-rose-100 bg-gradient-to-br from-white to-rose-50/30 shadow-xl shadow-rose-50/50 rounded-3xl overflow-hidden">
        <CardHeader className="p-8 flex flex-row items-center justify-between border-b border-rose-100/50">
          ...
          <Badge variant="outline" className="border-rose-200 text-rose-500">70% Clássico / 30% Moderno</Badge>
        </CardHeader>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="space-y-3">
              ...
              <ul className="text-neutral-600 text-sm space-y-2">
                <li className="flex items-center gap-2 italic"><span className="w-1 h-1 bg-rose-300 rounded-full" /> Alfaiataria sob medida</li>
                <li className="flex items-center gap-2 italic"><span className="w-1 h-1 bg-rose-300 rounded-full" /> Tecidos naturais (seda, linho)</li>
                <li className="flex items-center gap-2 italic"><span className="w-1 h-1 bg-rose-300 rounded-full" /> Cores neutras com contrastes</li>
              </ul>
            </div>
            <div className="space-y-3">
              <div className="flex items-center gap-2 text-rose-600">
              ...
              <ul className="text-neutral-600 text-sm space-y-2">
                <li className="flex items-center gap-2 italic"><span className="w-1 h-1 bg-rose-300 rounded-full" /> Metais prateados frios</li>
                <li className="flex items-center gap-2 italic"><span className="w-1 h-1 bg-rose-300 rounded-full" /> Formas geométricas limpas</li>
                <li className="flex items-center gap-2 italic"><span className="w-1 h-1 bg-rose-300 rounded-full" /> Bolsas de couro estruturadas</li>
              </ul>
            </div>
            <div className="space-y-3">
              <div className="flex items-center gap-2 text-rose-600">
              ...
              <div className="flex flex-wrap gap-2">
                {['Sofisticação', 'Poder', 'Clareza', 'Excelência', 'Respeito'].map(tag => (
