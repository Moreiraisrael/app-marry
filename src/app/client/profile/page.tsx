      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="md:col-span-1 space-y-6">
          <div className="p-8 rounded-[2.5rem] bg-white/60 backdrop-blur-xl border-none shadow-sm shadow-primary/5 text-center">
            ...
            <h2 className="text-xl font-bold text-foreground mb-1">Cliente Estilo</h2>
            <p className="text-primary text-[10px] font-bold uppercase tracking-widest">Membro Premium VIP</p>
          </div>
          ...
          <div className="p-8 rounded-[2.5rem] bg-white/60 backdrop-blur-xl border-none shadow-sm shadow-primary/5">
            ...
            <div className="space-y-4">
               {[
                 { label: 'Cartela', value: 'Verão Suave' },
                 { label: 'Arquétipo', value: 'Criativa' },
              ...
              <div className="space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-3">
                    ...
                    <Input name="fullName" className="bg-white/80 border-border/50 text-foreground rounded-2xl h-12" defaultValue="Cliente de Exemplo" />
                  </div>
                  <div className="space-y-3">
                    <Label className="text-[10px] text-muted-foreground uppercase tracking-[0.2em] font-bold">E-mail</Label>
                    <Input name="email" className="bg-secondary/40 border-transparent text-foreground/60 rounded-2xl h-12" defaultValue="cliente@exemplo.com" disabled />
                  </div>
                </div>

                <div className="space-y-3">
                  <Label className="text-[10px] text-muted-foreground uppercase tracking-[0.2em] font-bold">Sobre meu Estilo (Bio)</Label>
                  <textarea name="bio" className="w-full bg-white/80 border border-border/50 text-foreground rounded-2xl p-5 min-h-[120px] text-sm focus:ring-primary/20 transition-all outline-none font-medium leading-relaxed" placeholder="Conte um pouco sobre suas preferências de cores e estilo..." />
                </div>
