          ...
          <Card key={store.id} className="relative bg-black/40 border-amber-500/10 p-6 hover:border-amber-500/40 transition-all group overflow-hidden">
            ...
            <div className="space-y-4">
              ...
              <Link 
                ...
                target="_blank" 
                className="w-full h-10 border border-amber-500/20 rounded-xl text-amber-500 text-xs font-bold uppercase tracking-widest hover:bg-amber-500/10 transition-colors flex items-center justify-center"
              >
                Explorar Coleção
              </Link>
            </div>
